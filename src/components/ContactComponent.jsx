        ...
        <section className="contact-section-modern">
            ...
            <div className="contact-hero">
                ...
                <div className="contact-hero-action">
                    ...
                    <span className="cv-size">PDF, 2.4MB</span>
                </div>
            </div>
                    ...
                    <div className="contact-content-grid">
                        ...
                        <aside className="contact-sidebar">
                            ...
                            <div className="quick-links">
                                <a href="https://linkedin.com/in/mateo-castro" target="_blank" rel="noopener noreferrer" className="quick-link-item">
            ...
            <footer className="contact-footer">
                <div className="footer-content">
                    ...
                    <div className="footer-right">
                        <p>Junior Web Developer · In training · © 2026</p>
                    </div>
                </div>
            </footer>
        </section>
